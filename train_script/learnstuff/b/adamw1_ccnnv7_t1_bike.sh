task="adamw1_ccnnv7_t1_bike"

CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=3 PYTHONWARNINGS="ignore" HTTPS_PROXY="http://10.60.28.99:86" nohup python experiment_main.py  \
--task_id $task  \
--note "bike baseline on litle worst model"  \
--model "CompactCNNV7" \
