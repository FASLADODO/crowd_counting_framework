...
from .compact_cnn import CompactCNN, CompactCNNV2, CompactDilatedCNN, DefDilatedCCNN, DilatedCCNNv2, CompactCNNV6
from .my_ccnn import CustomCNNv1, CustomCNNv2, CustomCNNv3, CustomCNNv4
